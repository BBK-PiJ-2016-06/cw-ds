...
public class FunctionalListImplShould {

  private FunctionalListImpl myFunctList;
  private FunctionalListImpl emptyFunctList;

  @Before
  public void myFunctListSetUp() {
    myFunctList = new FunctionalListImpl();
    myFunctList.add("red");
  ...
  public void emptyFunctListSetUp() {
    emptyFunctList = new FunctionalListImpl();
  }
