...
public class FunctionalArrayListShould {

  private FunctionalArrayList myFunctList;
  private FunctionalArrayList emptyFunctList;

  @Before
  public void myFunctListSetUp() {
    myFunctList = new FunctionalArrayList();
    myFunctList.add("red");
  ...
  public void emptyFunctListSetUp() {
    emptyFunctList = new FunctionalArrayList();
  }
